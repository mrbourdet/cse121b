...
export function CalculateAge() {
    ...
    if (age <=3)
    {
        smartRemark = `What a baby!`;
    }
    else if (age < 3)
    {
        smartRemark = `Go find your mom!`;
    }
    else if (age < 7)
    {
        smartRemark = `You're a MID KID! (or is it a squid?)`;
    }
    else if (age < 12)
    {
        smartRemark = `Still Wet Behind the Ears`;
    }
    else if (age == 12)
    {
        smartRemark = `Congratulations. You're a tweenie`;
    }
    else if (age < 18)
    {
        smartRemark = `So now you are a teenager. I bet you know EVERYTHING.`;
    }
    else if (age < 21)
    {
        smartRemark= `You can vote, but you still can't get drunk. Sorry.`;
    }
    else if (age < 30)
    {
        smartRemark = `Sorry. You still can't drink. Word of Wisdom, remember?`;
    }
    else if (age < 40)
    {
        smartRemark = `Is that a wrinkle?`;
    }
    else if (age < 50 )
    {
        smartRemark = `Over the hill.`;
    }
    else if (age < 65)
    {
        smartRemark= `Now things are starting to fall apart`;
    }
    else if (age < 80)
    {
        smartRemark = `A little cranky are you?`;
    }
    else if (age < 100 )
    {
        smartRemark = `I bet they don't make the parts for you anymore.`;
    }
    else if (age < 110)
    {
        smartRemark = `Just getting out of bed is a victory.`;
    }
    else
    {
        smartRemark = `OK now you are OLD!`;
    }
